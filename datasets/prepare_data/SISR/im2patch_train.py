...
parser.add_argument('--DIV2K_dir', default='/data2/zongsheng/data/DIV2K/train', type=str, metavar='PATH',
                                      help="Path to save the HR images of DIV2K, (default: None)")
parser.add_argument('--Flickr_dir', default='/data2/zongsheng/data/Flickr2K/Flickr2K_HR', type=str, metavar='PATH',
                                      help="Path to save the HR images of Flickr2K, (default: None)")
parser.add_argument('--pch_size', default=512, type=int, metavar='PATH', help="Cropped patch size, (default: None)")
parser.add_argument('--stride', default=320, type=int, metavar='PATH', help="Stride for cropping")
args = parser.parse_args()

# check the floder to save the cropped patches
pch_dir = Path(args.DIV2K_dir).parent.parent / 'sisr_hr_patchs'
if not pch_dir.exists(): pch_dir.mkdir()
